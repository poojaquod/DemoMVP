...
import com.example.abc.demomvp.Demo3.Presenter.Frg_twoPresenter;
import com.example.abc.demomvp.Demo3.mvp.FragmentOneVP;
import com.example.abc.demomvp.R;

public class FragmentTwo extends BaseFragment implements FragmentOneVP.View {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        presenter = new Frg_twoPresenter(this);
